...
show_help() {
	...
	echo ""
	echo "Note: ccblocks now polls every ${CCBLOCKS_INTERVAL_MINUTES} minutes. There is no schedule to"
...
main() {
	...
	list | apply)
		...
		echo "ccblocks now polls every ${CCBLOCKS_INTERVAL_MINUTES} minutes — there is no schedule to configure."
